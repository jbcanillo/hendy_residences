...
|
*/
$config['base_url']	= ((isset($_SERVER['HTTPS']))? 'https://' : 'http://'). $_SERVER['HTTP_HOST'] .'/hendy_residences';
...
|
*/
$config['encryption_key'] = md5(sha1('wordstobook by Barking Bird'));
...
$config['sess_cookie_name'] = 'bb_session';
